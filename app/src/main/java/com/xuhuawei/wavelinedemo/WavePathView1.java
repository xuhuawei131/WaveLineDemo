...
public class WavePathView1 extends View {
    ...
    public WavePathView1(Context context) {
        super(context);
        init();
    }

    public WavePathView1(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public WavePathView1(Context context, AttributeSet attrs, int defStyleAttr) {
